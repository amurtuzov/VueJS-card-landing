                            ...
                            <div class="form-box row">                                						
                                ...
                                <div class="form-item">
                                        <float-label for="postal_code"> 
                                            <input type="text" name="postal_code" id="postal_code" class="input" placeholder="индекс" v-model="form_3.postal_code" />
                                        </float-label> 
                                    </div>
                                    <div class="form-item">
                        ...
                        <div  class="step-box step4" v-if="currentstep == 4" @click="form_4.errors.clear($event.target.name)">
                            <div class="form-box row">
                                ...
                                <div class="form-item wdt100">
                                        ...
                                        <selectpin name = "HintQ" v-model="form_4.HintQ"  :options="[{'lab':'Дата рождения бабушки','val':'Дата рождения бабушки'},{'lab':'Имя вашего питомца','val':'Имя вашего питомца'},{'lab':'Любимое место путешествия','val':'Любимое место путешествия'},{'lab':'Любимая спортивная команда','val':'Любимая спортивная команда'},{'lab':'Лучший друг детства','val':'Любимая спортивная команда'},{'lab':'Профессия дедушки','val':'Любимая спортивная команда'},{'lab':'Задайте собственный вопрос','val':'Задайте собственный вопрос'}]" ></selectpin>                                        
...
<p>Согласие на обработку персональных данных действует в течение срока действия Договора, а также в течение следующих 5 (Пяти) лет. По истечении указанного срока действия согласие считается продленным на каждые следующие 5 (Пять) лет при условии отсутствия у Банка сведений об его отзыве. Отзыв согласия осуществляется путем направления Клиентом письменного заявления в Банк, с даты получения которого Банк прекращает обработку персональных данных.</p>
        ...
        <modal v-if="showComplete" @close="showComplete = false">
            ...
            <div slot="body">
                <p>Ваша заявка на получение накопительной карты успешно отправлена в Банк, письмо-подтверждение направлено Вам по электронной почте.</p><p>В течение 3-х рабочих дней мы свяжемся с Вами для подтверждения данных Вашей заявки.</p>Всегда Ваш,<br>Русский Ипотечный Банк
            </div>            
            <div slot="footer">
...
.jq-selectbox__trigger{
    border: 0;
    background: url("./../../assets/images/s-arr.png") no-repeat center center;
    width: 60px;
}
...
.item-chk label:before{
    ...
    top: 0;
    display: block;
    background: url("./../../assets/images/chk.png") no-repeat bottom;
    width: 23px;
    height: 23px;
}
...
.form-box a.green-btn.prev:before {
    ...
    width: 29px;
    height: 22px;
    background-image: url(./../../assets/images/arrow-button-prev.png);
    left: 32px;
    top: calc(50% - 11px);
}
...
@media(max-width: 479px){
    ...
    .form-box.row .form-item {
        width: calc(100% - 32px);
    }
    .button-box .green-btn.prev {
        margin-right: 20px;
        padding-right: 20px;
    }
    .button-box .green-btn.next {
        padding-left: 20px;
    }
